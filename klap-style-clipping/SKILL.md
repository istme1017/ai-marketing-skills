...
3. [pipeline.md](pipeline.md) — the executable pipeline: Whisper word-level transcription → clip cutting → 9:16 reframe → ASS caption generation → ffmpeg burn-in. Run these steps with Bash.
